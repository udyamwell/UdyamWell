...
export const fetchAllCources= createAsyncThunk("lectures/fetchAllCourses",()=>{
    return axios.get(`https://www.udyamwell.com/api/v1/courses/fetch-lecture-data`).then((res) =>res.data).catch((err)=>{
        throw new Error(err.response.data.message); 
});
});

export const createCourse= createAsyncThunk("lectures/createCourse",(data)=>{
    return axios.post(`https://www.udyamwell.com/api/v1/courses/lecture-data`,data).then((res) =>res.data).catch((err)=>{
        throw new Error(err.response.data.message); 
});
});
...
export const updateCourse= createAsyncThunk("lectures/updateCourse",({_id,data})=>{
    ...
    return axios.put(`https://www.udyamwell.com/api/v1/courses/update-lecture-data/${_id}`,data).then((res) =>res.data).catch((err)=>{
        throw new Error(err.response.data.message); 
});
});
...
export const deleteCourse= createAsyncThunk("lectures/deleteCourse",(_id)=>{
    ...
    return axios.delete(`https://www.udyamwell.com/api/v1/courses/delete-lecture-data/${_id}`).then((res) =>res.data).catch((err)=>{
        throw new Error(err.response.data.message); 
});
});
