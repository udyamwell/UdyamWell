...
//     let token = localStorage.getItem("token");
//     return axios
//       .put(`http://localhost:8080/users/sign-in/${_id}`, data, {
//         headers: { Authorization: `Bearer ${token}` },
//       })
//       .then((res) => res.data)
//       .catch((err) => {
...
//   return axios
//     .post(`https://localhost:8080/users/sign-up`, data)
//     .then((res) => res.data)
//     .catch((err) => {
//       throw new Error(err.response.data.message);
//     });
...
//   let token = localStorage.getItem("token");
//   return axios
//     .put(`https://localhost:8080/users/update`, data, {
//       headers: { Authorization: `Bearer ${token}` },
//     })
//     .then((res) => res.data)
//     .catch((err) => {
...
//   let token = localStorage.getItem("token");
//   return axios
//     .delete(`https://localhost:8080/users/${_id}`, {
//       headers: { Authorization: `Bearer ${token}` },
//     })
//     .then((res) => res.data)
//     .catch((err) => {
...
export const fetchAllUsers = createAsyncThunk("user/fetchAllUsers", () => {
  let token = localStorage.getItem("token");
  return axios
    .get(`https://www.udyamwell.com/users`, {
      headers: { Authorization: ` Bearer ${token}` },
    })
    .then((res) => res.data)
    .catch((err) => {
...
export const updateUserAdmin = createAsyncThunk(
  ...
  ({ _id, data }) => {
    let token = localStorage.getItem("token");
    return axios
      .put(`https://www.udyamwell.com/users/update-admin/${_id}`, data, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((res) => res.data)
      .catch((err) => {
...
export const registerUser = createAsyncThunk("user/registerUser", (data) => {
  return axios
    .post(`https://www.udyamwell.com/users/sign-up`, data)
    .then((res) => res.data)
    .catch((err) => {
      throw new Error(err.response.data.message);
    });
...
export const updateUser = createAsyncThunk("user/updateUser", (data) => {
  let token = localStorage.getItem("token");
  return axios
    .put(`https://www.udyamwell.com/users/update`, data, {
      headers: { Authorization: `Bearer ${token}` },
    })
    .then((res) => res.data)
    .catch((err) => {
...
export const deleteUser = createAsyncThunk("user/deleteUser", (_id) => {
  let token = localStorage.getItem("token");
  return axios
    .delete(`https://www.udyamwell.com/users/${_id}`, {
      headers: { Authorization: ` Bearer ${token}` },
    })
    .then((res) => res.data)
    .catch((err) => {
