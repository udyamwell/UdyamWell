    ...
    return (
        ...
        <div className="HomeContainer" style={{margin:"3.5rem auto 0 auto"}}>
            <div className="banner" >
                <div className="bannerText">
                    <h1 style={{fontSize:"3.4rem",sx:{fontSize:"0.5rem",md:{fontSize:"1rem"}}}}>UdyamWell <span style={{color:"black"}}>Learning</span> System</h1>
        ...
        <Box display={'flex'} justifyContent={'center'} alignItems={'center'} sx={{margin:"2rem auto",backgroundColor:"#e0f1e5",padding:3,borderRadius:"55px"}} className='brochure'>
            <Typography variant='h6' color={'#266319'}>
                Interested in learning more? Join our latest  Programs!!
            </Typography>
            <Button variant='contained' sx={{color:"white",ml:3,p:"10px 50px",borderRadius:"25px"}}>Join Now</Button>
        </Box>
        {/*  */}
